...
go(int which_child)
{
  ...
  chdir("/");
      ...
      da:	29a50513          	add	a0,a0,666 # 1370 <malloc+0x11a>
      de:	00001097          	auipc	ra,0x1
      e2:	dc0080e7          	jalr	-576(ra) # e9e <chdir>
      e6:	00001997          	auipc	s3,0x1
      ea:	29a98993          	add	s3,s3,666 # 1380 <malloc+0x12a>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	28898993          	add	s3,s3,648 # 1378 <malloc+0x122>
  uint64 iters = 0;
      f8:	4481                	li	s1,0
  int fd = -1;
      fa:	5a7d                	li	s4,-1
      fc:	00001917          	auipc	s2,0x1
     100:	55490913          	add	s2,s2,1364 # 1650 <malloc+0x3fa>
    ...
    if(what == 1){
     ...
     10e:	27e50513          	add	a0,a0,638 # 1388 <malloc+0x132>
    ...
    if(what == 1){
     ...
     168:	23450513          	add	a0,a0,564 # 1398 <malloc+0x142>
     ...
     182:	20a50513          	add	a0,a0,522 # 1388 <malloc+0x132>
     ...
     1a6:	20e50513          	add	a0,a0,526 # 13b0 <malloc+0x15a>
     1aa:	00001097          	auipc	ra,0x1
     1ae:	cd4080e7          	jalr	-812(ra) # e7e <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	1be50513          	add	a0,a0,446 # 1370 <malloc+0x11a>
     ...
     1f0:	1cc50513          	add	a0,a0,460 # 13b8 <malloc+0x162>
     ...
     212:	1ba50513          	add	a0,a0,442 # 13c8 <malloc+0x172>
     ...
     256:	13650513          	add	a0,a0,310 # 1388 <malloc+0x132>
     25a:	00001097          	auipc	ra,0x1
     25e:	c3c080e7          	jalr	-964(ra) # e96 <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     262:	20200593          	li	a1,514
     266:	00001517          	auipc	a0,0x1
     26a:	17a50513          	add	a0,a0,378 # 13e0 <malloc+0x18a>
     ...
     282:	17250513          	add	a0,a0,370 # 13f0 <malloc+0x19a>
     ...
     294:	16850513          	add	a0,a0,360 # 13f8 <malloc+0x1a2>
     298:	00001097          	auipc	ra,0x1
     29c:	bfe080e7          	jalr	-1026(ra) # e96 <mkdir>
      close(open("grindir/../b/b", O_CREATE|O_RDWR));
     2a0:	20200593          	li	a1,514
     2a4:	00001517          	auipc	a0,0x1
     2a8:	15c50513          	add	a0,a0,348 # 1400 <malloc+0x1aa>
     ...
     2c0:	15450513          	add	a0,a0,340 # 1410 <malloc+0x1ba>
     ...
     2d2:	14a50513          	add	a0,a0,330 # 1418 <malloc+0x1c2>
     2d6:	00001097          	auipc	ra,0x1
     2da:	ba8080e7          	jalr	-1112(ra) # e7e <unlink>
      link("../grindir/./../a", "../b");
     2de:	00001597          	auipc	a1,0x1
     2e2:	0d258593          	add	a1,a1,210 # 13b0 <malloc+0x15a>
     2e6:	00001517          	auipc	a0,0x1
     2ea:	13a50513          	add	a0,a0,314 # 1420 <malloc+0x1ca>
     ...
     2fc:	14050513          	add	a0,a0,320 # 1438 <malloc+0x1e2>
     300:	00001097          	auipc	ra,0x1
     304:	b7e080e7          	jalr	-1154(ra) # e7e <unlink>
      link(".././b", "/grindir/../a");
     308:	00001597          	auipc	a1,0x1
     30c:	0b058593          	add	a1,a1,176 # 13b8 <malloc+0x162>
     310:	00001517          	auipc	a0,0x1
     314:	13850513          	add	a0,a0,312 # 1448 <malloc+0x1f2>
     ...
     348:	10c50513          	add	a0,a0,268 # 1450 <malloc+0x1fa>
     ...
     396:	0be50513          	add	a0,a0,190 # 1450 <malloc+0x1fa>
     ...
     3a8:	a8a080e7          	jalr	-1398(ra) # e2e <exit>
      ...
      sbrk(6011);
     3ac:	6505                	lui	a0,0x1
     3ae:	77b50513          	add	a0,a0,1915 # 177b <digits+0x73>
     ...
     3f6:	07e50513          	add	a0,a0,126 # 1470 <malloc+0x21a>
     ...
     422:	04a50513          	add	a0,a0,74 # 1468 <malloc+0x212>
     ...
     444:	01050513          	add	a0,a0,16 # 1450 <malloc+0x1fa>
     ...
     45e:	02650513          	add	a0,a0,38 # 1480 <malloc+0x22a>
     ...
     4ac:	fa850513          	add	a0,a0,-88 # 1450 <malloc+0x1fa>
     ...
     508:	f9450513          	add	a0,a0,-108 # 1498 <malloc+0x242>
     ...
     534:	f8058593          	add	a1,a1,-128 # 14b0 <malloc+0x25a>
     ...
     636:	e1e50513          	add	a0,a0,-482 # 1450 <malloc+0x1fa>
     ...
     650:	eb450513          	add	a0,a0,-332 # 1500 <malloc+0x2aa>
     ...
     664:	ea050513          	add	a0,a0,-352 # 1500 <malloc+0x2aa>
     ...
     67c:	e3858593          	add	a1,a1,-456 # 14b0 <malloc+0x25a>
     ...
     6c2:	e4250513          	add	a0,a0,-446 # 1500 <malloc+0x2aa>
     6c6:	00000097          	auipc	ra,0x0
     6ca:	7b8080e7          	jalr	1976(ra) # e7e <unlink>
     6ce:	bc91                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     6d0:	00001517          	auipc	a0,0x1
     6d4:	e3850513          	add	a0,a0,-456 # 1508 <malloc+0x2b2>
     ...
     6ee:	e3650513          	add	a0,a0,-458 # 1520 <malloc+0x2ca>
     ...
     708:	e3450513          	add	a0,a0,-460 # 1538 <malloc+0x2e2>
     ...
     724:	e3050513          	add	a0,a0,-464 # 1550 <malloc+0x2fa>
     ...
     73e:	e3e50513          	add	a0,a0,-450 # 1578 <malloc+0x322>
     ...
     826:	df658593          	add	a1,a1,-522 # 1618 <malloc+0x3c2>
     ...
     84a:	dda50513          	add	a0,a0,-550 # 1620 <malloc+0x3ca>
     ...
     864:	c3858593          	add	a1,a1,-968 # 1498 <malloc+0x242>
     868:	4509                	li	a0,2
     ...
     880:	c1c58593          	add	a1,a1,-996 # 1498 <malloc+0x242>
     884:	4509                	li	a0,2
     ...
     8dc:	cc858593          	add	a1,a1,-824 # 15a0 <malloc+0x34a>
     8e0:	4509                	li	a0,2
     ...
     950:	b0458593          	add	a1,a1,-1276 # 1450 <malloc+0x1fa>
     954:	4509                	li	a0,2
     ...
     99c:	c0858593          	add	a1,a1,-1016 # 15a0 <malloc+0x34a>
     9a0:	4509                	li	a0,2
     ...
     9e0:	bc458593          	add	a1,a1,-1084 # 15a0 <malloc+0x34a>
     9e4:	4509                	li	a0,2
     ...
     a48:	a0c58593          	add	a1,a1,-1524 # 1450 <malloc+0x1fa>
     a4c:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a70:	9fc50513          	add	a0,a0,-1540 # 1468 <malloc+0x212>
     a74:	00000097          	auipc	ra,0x0
     a78:	40a080e7          	jalr	1034(ra) # e7e <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	99c50513          	add	a0,a0,-1636 # 1418 <malloc+0x1c2>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     aba:	99a50513          	add	a0,a0,-1638 # 1450 <malloc+0x1fa>
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     ae8:	629c                	ld	a5,0(a3)
     aea:	6709                	lui	a4,0x2
     aec:	c0970713          	add	a4,a4,-1015 # 1c09 <digits+0x501>
    ...
    printf("grind: fork failed\n");
     ...
     b02:	95250513          	add	a0,a0,-1710 # 1450 <malloc+0x1fa>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f1e:	7ee50513          	add	a0,a0,2030 # 1708 <digits>
     f22:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1022:	69270713          	add	a4,a4,1682 # 16b0 <malloc+0x45a>
  ...
  putc(fd, 'x');
    ...
    10ac:	660b8b93          	add	s7,s7,1632 # 1708 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1100:	54c90913          	add	s2,s2,1356 # 1648 <malloc+0x3f2>
        while(*s != 0){
