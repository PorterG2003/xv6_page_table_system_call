...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	2c058593          	add	a1,a1,704 # 1320 <malloc+0x102>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	28e50513          	add	a0,a0,654 # 1328 <malloc+0x10a>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	36270713          	add	a4,a4,866 # 1428 <malloc+0x20a>
    ...
    panic("runcmd");
      ...
      e4:	25050513          	add	a0,a0,592 # 1330 <malloc+0x112>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	23658593          	add	a1,a1,566 # 1338 <malloc+0x11a>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	1fa58593          	add	a1,a1,506 # 1348 <malloc+0x12a>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	17450513          	add	a0,a0,372 # 1358 <malloc+0x13a>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	dcab8b93          	add	s7,s7,-566 # 1380 <malloc+0x162>
  ...
  while(peek(ps, es, "<>")){
     ...
     5cc:	d9850513          	add	a0,a0,-616 # 1360 <malloc+0x142>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6b4:	cd860613          	add	a2,a2,-808 # 1388 <malloc+0x16a>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6e4:	cc8b0b13          	add	s6,s6,-824 # 13a8 <malloc+0x18a>
  ...
  return ret;
     ...
     71e:	c7650513          	add	a0,a0,-906 # 1390 <malloc+0x172>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     780:	c1c50513          	add	a0,a0,-996 # 1398 <malloc+0x17a>
...
000000000000079a <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ba:	bfa60613          	add	a2,a2,-1030 # 13b0 <malloc+0x192>
     7be:	85ce                	mv	a1,s3
     7c0:	854a                	mv	a0,s2
...
0000000000000808 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     82a:	b92a0a13          	add	s4,s4,-1134 # 13b8 <malloc+0x19a>
  ...
  if(peek(ps, es, ";")){
     ...
     860:	b6460613          	add	a2,a2,-1180 # 13c0 <malloc+0x1a2>
     864:	85ce                	mv	a1,s3
     866:	854a                	mv	a0,s2
...
00000000000008b0 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8c6:	ac660613          	add	a2,a2,-1338 # 1388 <malloc+0x16a>
  ...
  if(!peek(ps, es, ")"))
     ...
     8f6:	ae660613          	add	a2,a2,-1306 # 13d8 <malloc+0x1ba>
     8fa:	85ca                	mv	a1,s2
     8fc:	8526                	mv	a0,s1
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     974:	ad070713          	add	a4,a4,-1328 # 1440 <malloc+0x222>
...
00000000000009ec <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a20:	8fc60613          	add	a2,a2,-1796 # 1318 <malloc+0xfa>
     a24:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    panic("syntax");
     ...
     a68:	92c50513          	add	a0,a0,-1748 # 1390 <malloc+0x172>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10c8:	35c90913          	add	s2,s2,860 # 1420 <malloc+0x202>
        while(*s != 0){
